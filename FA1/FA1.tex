...
\title[Challenges of open innovation]{A Summary of West and Gallagher's 'Challenges of open innovation: the paradox of firm investment in open-source software'} % The short title appears at the bottom of every slide, the full title is only on the title page
